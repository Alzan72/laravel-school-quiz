        ...
        <div class="row">
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ url('/exam/exam/create') }}" class="btn btn-success btn-sm" title="Add New Exam">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                        </a>

                        <form method="GET" action="{{ url('/exam/exam') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Name</th><th>Dekskripsi</th><th>Topic Id</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
