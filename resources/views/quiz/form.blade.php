...
<div class="form-group {{ $errors->has('answer1') ? 'has-error' : ''}}">
    ...
    <input type="radio" id="answer" name="answer" value="{{ $quiz->answer1 }}"  {{ $answer=='A' ? 'checked':'' }}>
...
<div class="form-group {{ $errors->has('answer2') ? 'has-error' : ''}}">
    ...
    <input type="radio" id="answer" name="answer" value="{{ $quiz->answer2 }}"  {{ $answer=='B' ? 'checked':'' }}>
...
<div class="form-group {{ $errors->has('answer3') ? 'has-error' : ''}}">
    ...
    <input type="radio" id="answer" name="answer" value="{{ $quiz->answer3 }}"  {{ $answer=='C' ? 'checked':'' }}>
...
<div class="form-group {{ $errors->has('answer4') ? 'has-error' : ''}}">
    ...
    <input type="radio" id="answer" name="answer" value="{{ $quiz->answer4 }}" {{ $answer=='D' ? 'checked':'' }}>
