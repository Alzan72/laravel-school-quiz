        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ url('/quiz/quiz/create') }}" class="btn btn-success btn-sm" title="Add New Quiz">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Group Id</th><th>Number</th><th>Question</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($quiz as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form method="POST" action="{{ url('/quiz/quiz' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
